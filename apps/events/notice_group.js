  ...
  switch (e.sub_type) {
    case "increase": {
      if (e.user_id === (e.bot ?? Bot).uin) {
        ...
        logger.info("[Yenai-Plugin-Libre]新增群聊")
        ...
        logger.info("[Yenai-Plugin-Libre]新增群员")
    ...
    case "decrease": {
      if (e.dismiss) {
        ...
        logger.info("[Yenai-Plugin-Libre]群聊被解散")
        ...
        logger.info("[Yenai-Plugin-Libre]机器人被踢")
        ...
        logger.info("[Yenai-Plugin-Libre]机器人退群")
        ...
        logger.info("[Yenai-Plugin-Libre]群员退群")
        ...
        logger.info("[Yenai-Plugin-Libre]群员被踢")
    ...
    case "admin": {
      ...
      e.set ? logger.info("[Yenai-Plugin-Libre]机器人被设置管理") : logger.info("[Yenai-Plugin-Libre]机器人被取消管理")
      if (e.user_id === (e.bot ?? Bot).uin) {
        msg = [
          segment.image(
              `https://p.qlogo.cn/gh/${e.group_id}/${e.group_id}/100`
        ...
        e.set ? logger.info("[Yenai-Plugin-Libre]新增群管理员") : logger.info("[Yenai-Plugin-Libre]取消群管理员")
    ...
    case "ban": {
      ...
      if (e.duration == 0) {
        logger.info("[Yenai-Plugin-Libre]机器人被解除禁言")
        msg = [
          segment.image(
              `https://p.qlogo.cn/gh/${e.group_id}/${e.group_id}/100`
          ),
        ...
        logger.info("[Yenai-Plugin-Libre]机器人被禁言")
    ...
    case "transfer": {
      ...
      logger.info("[Yenai-Plugin-Libre]群聊转让")
    ...
    case "recall": {
      ...
      isManage ? logger.info("[Yenai-Plugin-Libre]群聊管理撤回") : logger.info("[Yenai-Plugin-Libre]群聊撤回")
      // 发送的消息
      msg = [
        segment.image(`https://p.qlogo.cn/gh/${e.group_id}/${e.group_id}/100`),
